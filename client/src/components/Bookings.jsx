      ...
      <div className="rounded-lg  ">
        <div className="justify-between mb-6 rounded-lg border-[1px] border-stone-300  bg-white p-6 shadow-md sm:flex sm:justify-start">
          <img
            ...
            className="w-full h-[14rem] rounded-lg sm:w-[17rem]"
          />
          ...
          <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
            ...
            <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
              ...
              <div className="flex items-center space-x-4">
                <button className="text-white bg-gradient-to-r mt-[56px] from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                  Cancel Tickets
                </button>
              </div>
            </div>
