  ...
  return (
    <div className="">
      <div className="md:w-3/4 m-auto  ">
        ...
        <div className="items-start mb-2 grid grid-cols-3">
          {unleashDataMuseum.map((d) => (
            <div
              key={d.item}
              className="mb-5 md:block w-[22px] cursor-pointer bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] flex-none  md:w-[95%]  md:pb-4 border rounded-lg"
            >
